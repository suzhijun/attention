...
# __C.TEST.RPN_NMS_THRESH_REGION = 0.7
...
# Test part
cfg.TEST.MPN_BBOX_NUM = 128
cfg.TEST.MPN_REGION_NUM = 128
cfg.TEST.MPN_OBJ_REL_THRESH = 0.65
cfg.TEST.MPN_MAX_OBJECTS = 15
topN_covers=cfg.TEST.MPN_COVER_NUM = 512
cfg.TEST.MPN_MAKE_COVER_THRESH = 0.4
