...
def proposal_target_layer(object_rois, region_rois, scores_object, scores_relationship,
									 ...
									 is_training, graph_generation=False):
    ...
    if is_training:
        ...
        object_labels, bbox_targets_object, bbox_inside_weights_object, bbox_outside_weights_object, phrase_labels= [None] * 6
...
def _sample_rois(object_rois, gt_objects, gt_relationships, num_images, num_classes):
...
def _sample_rois(object_rois, gt_objects, gt_relationships, gt_box_relationship, num_images, num_classes_obj, num_classes_pred):
	...
	bbox_targets, bbox_inside_weights = \
		_get_bbox_regression_labels(bbox_target_data, num_classes_obj)
