...
def check_obj_rel_recall(gt_objects, gt_relationships, gt_boxes_relationship, rel_covers, obj_rois,
	...
	obj_overlaps = obj_overlaps >= object_thresh
	...
	rel_overlaps[keep_obj_ind == False] = 0
	...
	fg_cover_bool = np.logical_and(obj_overlaps[subject_selected, cover_sub_gt_assignment],
								   obj_overlaps[object_selected, cover_obj_gt_assignment])
	...
	fg_cover_inds = rel_overlaps.max(axis=1) > 0
